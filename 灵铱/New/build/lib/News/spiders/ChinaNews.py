...
class ChinanewsSpider(CrawlSpider):
    ...
    def parse_info(self, response):
        ...
        # 获取图片链接
        image_urls = response.xpath('//div[@class="content"]/div[@class="left_zw"]/div//img/@src | //div[@class="content"]/div[@class="left_zw"]/p//img/@src').extract()
        content = ''.join(response.xpath('//div[@class="content"]/div[@class="left_zw"]/div | //div[@class="content"]/div[@class="left_zw"]/p').extract())
        listFiles = []
