...
class JunshiSpider(CrawlSpider):
    ...
    start_urls = ['http://world.gmw.cn/']

    rules = (
        # Rule(LinkExtractor(allow=r'http://world.gmw.cn/node_\d+\.htm')),
        Rule(LinkExtractor(allow=r'http://world.gmw.cn/node_\d+\w+\.htm'), callback='parse_item', follow=True),
