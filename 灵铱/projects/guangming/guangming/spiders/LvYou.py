...
class JunshiSpider(CrawlSpider):
    ...
    start_urls = ['http://travel.gmw.cn/']

    rules = (
        Rule(LinkExtractor(allow=r'http://travel.gmw.cn/node_\d+\w+\.htm'), callback='parse_item', follow=True),
    ...
    def parse_item(self, response):
        ...
        for div in div_list:
            ...
            urls = 'http://travel.gmw.cn/' + str(link)
