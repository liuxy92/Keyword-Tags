...
class CaiJingSpider(CrawlSpider):
    ...
    start_urls = ['http://cj.taihainet.com/']
    # start_urls = ['http://www.taihainet.com/news/txnews/cnnews/sh/2018-03-11/2111205.html']

    rules = (
        Rule(LinkExtractor(allow=r'http://www.taihainet.com/news/finance/^[a-z]{2:4}$/')),
