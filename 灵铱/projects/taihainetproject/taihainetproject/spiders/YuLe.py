...
class YuleSpider(CrawlSpider):
    ...
    start_urls = ['http://yl.taihainet.com/']

    rules = (
        Rule(LinkExtractor(allow=r'http://www.taihainet.com/news/pastime/^[a-z]{4:8}$/')),
    ...
    def parse_item(self, response):
        ...
        SourceCategory = response.xpath(
            '//div[@class="list-path wrapper ovv"]/a[last()]/text() |'
            '//div[@class="crumb"]/a[last()]/text()'
        ).extract_first()
