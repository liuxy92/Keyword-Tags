...
class QicheSpider(CrawlSpider):
    ...
    start_urls = [
        'http://auto.takungpao.com/industry/',
        'http://auto.takungpao.com/guide/',
        'http://auto.takungpao.com/trial/',
        'http://auto.takungpao.com/new/',
        'http://auto.takungpao.com/refit/',
        'http://auto.takungpao.com/strategy/',
        'http://auto.takungpao.com/maint/',
        'http://auto.takungpao.com/review/',
        'http://auto.takungpao.com/culture/',
    ]

    rules = (
        Rule(LinkExtractor(allow=r'http://auto.takungpao.com/[a-z]+/index.*\.htm'), callback='parse_item', follow=True),
    )
    ...
    def parse_item(self, response):
        ...
        div_list = response.xpath(
            '//div[@class="listText fr_dib"]/h1/a | '
            '//div[@class="txtImgListeach current"]/h3/a')
        for div in div_list:
    ...
    def parse_info(self, response):
        ...
        item['NewsDate'] = response.xpath(
            '//div[@class="fl_dib"][1]/text() |'
            '//div[@class="articleInforL"]/span[@class="time"]/text()').extract_first()
        ...
        image_urls = response.xpath(
            '//div[@class="tpk_con clearfix"]/div[@class="tpk_text clearfix"]/p/img/@src').extract()
        try:
            content = ''.join(
                response.xpath(
                    '//div[@class="tpk_con clearfix"]/div[@class="tpk_text clearfix"]/p |'
                    '//div[@class="text"]/p').extract())
        except:
            content = 'None'
        headers = {
