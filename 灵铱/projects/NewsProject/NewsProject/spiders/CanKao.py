...
from ..items import NewsprojectItem
...
class CankaoSpider(scrapy.Spider):
    ...
    def parse(self, response):
        div_list = response.xpath('//div[@class="headNav ov"]/ul/li/strong/a/@href').extract()
    ...
    def parse_info(self, response):
        ...
        # 获取图片链接
        image_urls = response.xpath('//div[@class="inner"]/div/p/a/img/@src | //div[@class="thumb-box f-l"]/ul/li/a/img/@src').extract()
        # print(image_urls)
        ...
        if image_urls is not None:
            ...
            item['NewsContent'] = ''.join(
                response.xpath('//div[@class="inner"]/div/p | //div[@class="thumb-box f-l"]/ul/li/a/img/@alt').extract())
