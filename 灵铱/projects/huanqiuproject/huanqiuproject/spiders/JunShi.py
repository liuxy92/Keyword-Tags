...
class HqSpider(CrawlSpider):
    ...
    start_urls = [
        ...
        'http://mil.huanqiu.com/strategysituation/',
        'http://mil.huanqiu.com/aerospace/',
        # 'http://mil.huanqiu.com/milmovie/',
    ]


    rules = (
        Rule(LinkExtractor(allow=r'http://mil.huanqiu.com/[a-z]+/\w+\.html'), callback='parse_item', follow=True),
    )
