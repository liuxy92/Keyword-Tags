...
class HqSpider(CrawlSpider):
    ...
    start_urls = ['http://ent.huanqiu.com/article/']

    rules = (
        Rule(LinkExtractor(allow=r'http://ent.huanqiu.com/article/\w+\.html'), callback='parse_item', follow=True),
    )
    ...
    def parse_info(self, response):
        ...
        SourceName = response.xpath(
            ...
            '//div[@class="summaryNew"]/strong/a/text() |'
            '//div[@class="summaryNew"]/strong[@id="source_baidu"]/text()'
        ).extract_first()
