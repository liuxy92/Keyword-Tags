...
class HqSpider(CrawlSpider):
    ...
    start_urls = [
        'http://tech.huanqiu.com/original/',
        'http://tech.huanqiu.com/internet/',
        'http://tech.huanqiu.com/comm/',
        'http://tech.huanqiu.com/it/',
        'http://tech.huanqiu.com/science/'
        'http://tech.huanqiu.com/net/',
        'http://tech.huanqiu.com/business/',
        'http://tech.huanqiu.com/discovery/',
        'http://tech.huanqiu.com/game/',
        'http://tech.huanqiu.com/fantasy/'
    ]

    rules = (
        Rule(LinkExtractor(allow=r'http://tech.huanqiu.com/[a-z]+/\w+\.html'), callback='parse_item', follow=True),
    )
    ...
    def parse_info(self, response):
        ...
        if SourceName is not None:
            if SourceName == ' ':
                item['SourceName'] = SourceName.replace(' ', '环球网')
            else:
