...
class HqSpider(CrawlSpider):
    ...
    start_urls = [
        ...
        'http://finance.huanqiu.com/zhengq/',
        'http://finance.huanqiu.com/ssgs/',
        'http://finance.huanqiu.com/baoxianl/',
        'http://finance.huanqiu.com/xiaofeil/',
        'http://finance.huanqiu.com/caigc/',
        'http://finance.huanqiu.com/lingdu/',
        'http://finance.huanqiu.com/jijinx/',
        'http://finance.huanqiu.com/gjcx/',
        'http://finance.huanqiu.com/chuangr/',
        'http://finance.huanqiu.com/quyuy/',
        'http://finance.huanqiu.com/shangh/',
        'http://finance.huanqiu.com/hqsl/',
    ]

    rules = (
        Rule(LinkExtractor(allow=r'http://finance.huanqiu.com/[a-z]+/\w+\.html'), callback='parse_item', follow=True),
    )
